...
def ResNet20(nc, nclasses):
    return Cifar10ResNet(nc, nclasses, BasicBlock, n=3)


def ResNet32(nc, nclasses):
    return Cifar10ResNet(nc, nclasses, BasicBlock, n=5)
...
def ResNet44(nc, nclasses):
    return Cifar10ResNet(nc, nclasses, BasicBlock, n=7)
...
def ResNet56(nc, num_classes):
    return Cifar10ResNet(nc, BasicBlock, n=9,)
...
def ResNet110(nc, num_classes):
    return Cifar10ResNet(nc, BasicBlock, n=18)
